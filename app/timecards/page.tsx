  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white pb-24 pt-14">
      ...
      <div className="px-4 pt-6 max-w-lg mx-auto">
        ...
        {/* Full Record link */}
        {selectedUserId && selectedUser && activeView === 'individual' && ['ops_manager', 'owner', 'sales_director', 'developer'].includes(session.role) && (
          <div className="mb-3">
            <a href={`/employee-record?id=${selectedUserId}`}
              ...
              View Full Employee Record for {selectedUser.full_name}
            </a>
          </div>
        )}
