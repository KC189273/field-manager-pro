...
<tr><td style="background:#450a0a;padding:28px 40px;text-align:center;">
  <p style="color:#fca5a5;font-size:10px;letter-spacing:3px;text-transform:uppercase;margin:0 0 6px;font-family:'Arial',sans-serif;">${orgName}</p>
...
<tr><td style="padding:30px 40px;">
  <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;margin-bottom:28px;font-family:'Arial',sans-serif;">
    <tr style="background:#f8fafc;"><td style="padding:10px 14px;font-size:10px;color:#94a3b8;text-transform:uppercase;letter-spacing:1px;width:170px;border-right:1px solid #e2e8f0;border-bottom:1px solid #e2e8f0;">Employee</td><td style="padding:10px 14px;font-size:13px;font-weight:bold;color:#0f172a;border-bottom:1px solid #e2e8f0;">${employeeName}</td></tr>
    <tr><td style="padding:10px 14px;font-size:10px;color:#94a3b8;text-transform:uppercase;letter-spacing:1px;border-right:1px solid #e2e8f0;border-bottom:1px solid #e2e8f0;">Organization</td><td style="padding:10px 14px;font-size:13px;color:#0f172a;border-bottom:1px solid #e2e8f0;">${orgName}</td></tr>
    ...
    <tr><td style="padding:10px 14px;font-size:10px;color:#94a3b8;text-transform:uppercase;letter-spacing:1px;border-right:1px solid #e2e8f0;border-bottom:1px solid #e2e8f0;">District Manager</td><td style="padding:10px 14px;font-size:13px;color:#0f172a;border-bottom:1px solid #e2e8f0;">${dmName}</td></tr>
    <tr style="background:#f8fafc;"><td style="padding:10px 14px;font-size:10px;color:#94a3b8;text-transform:uppercase;letter-spacing:1px;border-right:1px solid #e2e8f0;">Approved By</td><td style="padding:10px 14px;font-size:13px;color:#0f172a;">${sdName}</td></tr>
  </table>

  <p style="font-size:14px;color:#1e293b;line-height:1.8;margin:0 0 24px;font-family:'Arial',sans-serif;">
    Dear <strong>${employeeName}</strong>,<br><br>
    This letter serves as formal notification that your employment with <strong>${orgName}</strong> has been terminated, effective <strong>${terminationDate}</strong>.
  </p>
  ...
  <div style="margin-bottom:28px;">
    ...
    <div style="background:#fef2f2;border-left:4px solid #dc2626;padding:14px 16px;font-size:13px;color:#1e293b;line-height:1.75;font-family:'Georgia',serif;">${reasons.replace(/\n/g, '<br>')}</div>
  </div>
  ...
  <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:4px;padding:16px 20px;margin-bottom:24px;">
    <p style="font-size:13px;color:#374151;margin:0;line-height:1.7;font-family:'Arial',sans-serif;">
      Please coordinate with <strong>${dmName}</strong> regarding your final paycheck, return of any company property, and any questions about this notice.
  ...
  <p style="font-size:12px;color:#94a3b8;margin:0;line-height:1.7;font-family:'Arial',sans-serif;">
    This termination decision was reviewed and approved by <strong>${sdName}</strong> on <strong>${terminationDate}</strong>.<br>
...
<tr><td style="background:#f1f5f9;border-top:1px solid #e2e8f0;padding:18px 40px;">
  <p style="font-size:10px;color:#94a3b8;font-family:'Arial',sans-serif;margin:0;line-height:1.7;">
    ...
    Confidential — For authorized personnel only. &copy; ${new Date().getFullYear()} ${orgName}.
  </p>
</td></tr>
</table></td></tr></table>
</body></html>`
